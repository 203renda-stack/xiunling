...
// Using simple SVGs for icons to avoid external dependencies
export const Icons = {
...
export const MOODS = [
  ...
  { score: 2, emoji: '😟', label: '焦虑' },
  { score: 3, emoji: '😐', label: '平静' },
  { score: 4, emoji: '🙂', label: '不错' },
  { score: 5, emoji: '😁', label: '开心' },
];

export const DISCLAIMER_TEXT = "心灵 (XinLing) 是一个AI伴侣，旨在提供情感支持和日常陪伴。我不是医疗专业人员。如果您或您认识的人正处于危机中，请立即联系紧急服务或专业心理医生。";